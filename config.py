...
SRC_EMAIL = "chinmax1990@gmail.com"  #Your gmail account for sending mail to Kindle
DOMAIN = "https://javendaily20160714.appspot.com" #Your domain of app

TIMEZONE = 8  #Default timezone, you can modify it in webpage after deployed

DEFAULT_MASTHEAD = "mh_javendaily.gif" #default masthead
DEFAULT_COVER = "cv_javendaily.jpg" #default cover, leave it empty will not add cover to book
DEFAULT_COVER_BV = "cv_javendaily.jpg" #default cover for merged-book, None indicates paste all covers into one

MY_FEEDS_TITLE = u'JavenDaily'
MY_FEEDS_DESC = u'RSS delivering from JavenDaily'
